...
void main()
{
    ...
    vec2 reflection_texcoord = vec2(
        atan(reflection_direction.z, reflection_direction.x) / PI * 0.5 + 0.5,
        -atan(reflection_direction.y, length(reflection_direction.xz)) / PI + 0.5
    );
